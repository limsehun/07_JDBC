...
public class UserView {
	...
	private void selectAll() throws Exception {
		...
		// 서비스 메서드(SELECT) 호출 후 결과(List<User>) 반환 받기
	...
	private void insertUser2() throws Exception{
		...
		String userId = null; // 입력된 아이디를 저장힐 변수
	...
	private void multiInsertUser() throws Exception{
		...
		for(int i = 0; i<input; i++) {
			...
			while(true) {
				System.out.print((i+1)+"번쨰 userId : ");
				userId = sc.nextLine();
			...
			System.out.print((i+1)+"번쨰 userPw : ");
			String userPw = sc.nextLine();
			
			System.out.print((i+1)+"번쨰 userName : ");
			String userName = sc.nextLine();
		...
		// -> result엔 결과로 삽입된 행의 개수가 반환되어 들어있다
