...
public class UpdateServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String ditail = req.getParameter("detail"); //내용(textarea)
		...
		try {
			...
			boolean result = service.todoUpdate(index, title, ditail);
			
			// 수정 성공시
			// 상세 조회 페이지로 redirect 후 "수정되었습니다" alert() 출력
			
			// 수정 실패시
			// 수정 화면으로 rediret 후 "수정 실패" alert() 출력
